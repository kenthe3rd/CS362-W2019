...
**  village card; basic testing logic carried over from assignment 3,
...
void villageRandomTest(){
    int i, j, k, numVillages, otherPlayersHand, money, card, cardsInDeck, villagesInDiscard1, villagesInDiscard2, numPlayers;
    ...
    printf("Playing 10000 games where Village is the only card played\n");
    for( i=0; i<10000; ++i ){
        numPlayers = rand() % 3 + 2;
